BURIQ () {
curl -sS https://raw.githubusercontent.com/zoolztheaz1990/instalasi/main/register > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/zoolztheaz1990/instalasi/main/register | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/zoolztheaz1990/instalasi/main/register | awk '{print $4}' | grep $MYIP)
if [ "$MYIP" = "$IZIN" ]; then
Bloman
else
...
Exp=$(curl -sS https://raw.githubusercontent.com/zoolztheaz1990/instalasi/main/register | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/zoolztheaz1990/instalasi/main/versions)
